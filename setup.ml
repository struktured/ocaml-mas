...
(* OASIS_START *)
(* DO NOT EDIT (digest: a430561386d1f231bded1fbc9db72bd8) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Gen_ext"; "Mas_intf"; "Mas_core"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\185\192\022\166\017\210*\24006\214\020\191\235 ^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
