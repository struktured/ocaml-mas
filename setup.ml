...
(* OASIS_START *)
(* DO NOT EDIT (digest: fb5b616a06455e6966e70a1e25f01eaa) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "environments";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "examples";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\175W\171@\014\174X\152\157\r\164*\2407\002\031";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
