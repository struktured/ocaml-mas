...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3c443cc4cc935601a949251d0e236248) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving.ord", None);
                           FindlibPackage ("ppx_deriving.show", None);
                           FindlibPackage ("ppx_deriving.iter", None);
                           FindlibPackage ("ppx_deriving_protobuf", None);
                           FindlibPackage ("prob_cache_containers", None);
                           FindlibPackage ("oml", None)
                        ];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mas_core";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_core_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/core/async";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "mas_core";
                   ...
                   {
                      lib_modules = ["Mas_async_system"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_core_async";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_value_functions";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/value_functions";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mas_core"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules =
                        ["Value_function"; "Discrete_value_function"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_value_functions";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_value_functions_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/value_functions/async";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mas_core_async"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Async_value_function"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_value_functions_async";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_learning_rules";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/learning_rules";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "mas_core";
                           InternalLibrary "mas_value_functions"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules =
                        ["One_step_learner"; "Q_learner"; "Sarsa_learner"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_learning_rules";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_learning_rules_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/learning_rules/async";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "mas_core_async";
                           InternalLibrary "mas_value_functions_async";
                           InternalLibrary "mas_learning_rules_async"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Async_learner"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_learning_rules_async";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_policies";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_policies";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_policies_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Async_policy"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_policies_async";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mas_core";
                           InternalLibrary "mas_value_functions";
                           InternalLibrary "mas_policies";
                           InternalLibrary "mas_learning_rules"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["State_based_agent"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_agents";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_agents_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/agents/async";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "mas_core_async";
                           InternalLibrary "mas_value_functions_async";
                           InternalLibrary "mas_policies_async";
                           InternalLibrary "mas_learning_rules_async";
                           InternalLibrary "mas_agents_async"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Async_agent"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_agents_async";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_environments";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Two_agent"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_environments";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_environments_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/environments/async";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "mas_core_async";
                   ...
                   {
                      lib_modules = ["Agent_pipe"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_environments_async";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mas_core";
                           InternalLibrary "mas_value_functions";
                           InternalLibrary "mas_environments";
                           InternalLibrary "mas_agents";
                   ...
                   {
                      lib_modules = ["Decorators"; "Archimedes_plot"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_plot";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mas_examples";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Narmed_bandit"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mas_examples";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Multiagent System API";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "8\227\187r\018\178\017\005\226\1819\023\198n|\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
