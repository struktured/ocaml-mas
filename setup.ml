...
(* OASIS_START *)
(* DO NOT EDIT (digest: efcd70edd881783e6c890b7be2ece428) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Two_agent"; "Turn_based"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mas_plot"; "Archimedes_plot"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\210\254\214]QH\128\025#\240\227O\173&)\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
